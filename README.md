...
### **Attention Heatmap**
The SeqDA-HLA model leverages attention mechanisms to visualize the binding patterns between HLA and peptides. Each column show the binding pattern of various peptides with the same HLA type.
